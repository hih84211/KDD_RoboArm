...
class JointStatePublisherGui(QWidget):
    ...
    def __init__(self, title, jsp, num_rows=0):
        ...
        # Hard code alert!!! This is bad.
        self.publishers =dict(zip(self.jsp.joint_list, [rospy.Publisher('/KDD_RoboArm/x_position_controller/command', Float64, queue_size = 1), 
