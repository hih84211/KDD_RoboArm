...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 25 02:54:02 2021
...
class JointInfo():
    ...
    def __init__(self):
        ...
        s = open('/home/peter/catkin_ws/src/KDD_RoboArm/robots/KDD_RoboArm.urdf' , mode='r', encoding='utf-8-sig').read()
        robot = xml.dom.minidom.parseString(s)
    ...
    def update(self, delta):
        # dict.items() 為Python3 語法，想當於Python2 的dict.iteritems()
        for name, joint in self.free_joints.items():
